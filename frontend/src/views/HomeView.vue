...
<template>
  ...
  <div v-else>
    <div class="mb-8 text-center">
      <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">DiceRoll 3D</h1>
      <p class="mt-4 text-lg text-gray-600">Una app de dados virtuales con animaciones 3D, historial de tiradas y modo oscuro para juegos de mesa o decisiones al azar.</p>
